...
# cria e retorna um Container que representa uma letra da palavra oculta no jogo — seja um sublinhado ("_") no início ou uma letra revelada após o acerto.
...
def main(page: ft.Page):
    ...
    avaible_words = ['Cogumelo', 'Flor', 'Estrela', 'Luigi', 'Peach', 'Bowser', 'Toad', 'Mario', 'Princesa']
