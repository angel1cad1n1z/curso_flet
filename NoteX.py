...
# Define o layout e comportamento da página NoteX.
def main(page: ft.Page):
    page.bgcolor = ft.colors.BLACK
    page.title = 'NoteX'

    # Aplica ou remove sombra a um elemento ao passar o mouse sobre ele.
    def apply_shadow(e):
        if e.control.shadow:
    ...
    # Abre uma nota quando o usuário clica em um item de nota.
    def open_note(e):
        page.controls.pop()
    ...
    # Gera a lista de notas para exibir na página.
    def notes():
    ...
    # Botão flutuante para adicionar uma nova nota.
    ...
    # Retorna à página inicial ao clicar no botão de voltar.
    def go_to_home(e):
        page.controls.pop()
    ...
    # Define o layout da página de detalhes da nota.
